...
public:
  ...
  /**
   * @brief Copies JPEG representation of the image and returns it as a simple
   *        string (in base64 coding).
   * @return std::string with serialized image
   *
   * @throw std::runtime_error if unexpected error occured
   */
